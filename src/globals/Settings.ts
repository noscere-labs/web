  ...
  fields: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          required: true,
          defaultValue:
            "We partner with enterprise clients to demystify blockchain, unlocking its strategic value to turn emerging possibilities into competitive advantage.",
          admin: {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "textarea",
          defaultValue:
            "Blockchain is a powerful tool for innovation and transformation. At Noscere, we help enterprises harness its potential to drive strategic value.",
          admin: {
        ...
        },
        {
          ...
          admin: {
            description:
              'Company statistics (e.g., "Years in Blockchain", "8+")',
          },
        },
      ],
    },
